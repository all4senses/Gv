 ...
 * @ingroup themeable
 */
function gv_pager_link($variables) {
...
function gv_preprocess_node(&$variables) {
  ...
  if(isset($variables['node'])) {
    ...
    elseif($variables['node']->type == 'quote') {
            ...
            elseif($variables['node']->title == 'Request a Quote page v9_uk' || $variables['node']->title == 'Request a Quote page v9_uk Final') {
                $body_classes_add['quote_page'] = 'quote-page v9 uk';
                $variables['theme_hook_suggestions'][] = 'node__quote__v9_uk';
            }
            elseif($variables['node']->title == 'Request a Quote page v9_ca' || $variables['node']->title == 'Request a Quote page v9_ca Final') {
                $body_classes_add['quote_page'] = 'quote-page v9 ca';
                $variables['theme_hook_suggestions'][] = 'node__quote__v9_ca';
            }
            ...
            elseif($variables['node']->title == 'Request a Quote page v8_ca' || $variables['node']->title == 'Request a Quote page v8_ca Final') {
                $body_classes_add['quote_page'] = 'quote-page v8 ca';
                $variables['theme_hook_suggestions'][] = 'node__quote__v8_ca';
            }
            ...
            elseif($variables['node']->title == 'Request a Quote page v7_uk_ppc' || $variables['node']->title == 'Request a Quote page v7_uk_ppc Final') {
                $body_classes_add['quote_page'] = 'quote-page v7 uk';
                $variables['theme_hook_suggestions'][] = 'node__quote__v7_uk_ppc';
            }
