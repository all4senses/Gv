<div id="v33">
  ...
  <div class="verisign"></div><div class="protected">
  <div class="partners">
    ...
    <div class="left">
      <?php 
        if ($_SERVER['REDIRECT_URL'] == '/compare-voip-solutions-final') {
          echo '<a class="guide" href="/pdfs/Business-VoIP-Guide.pdf" target="_blank">' . t("Download Your Free VoIP Buyer's Guide Here") . '</a><div class="quote-final">' . t('<p><strong>Thank you</strong> for taking your time to complete our form. A VoIP Expert will be contacting you shortly to provide you with a personalized VoIP Service quote.</p><p>In the meantime, you can gain a great deal of VoIP information right here at <a href="http://getvoip.com">GetVoIP.com</a></p>') . '</div>';
