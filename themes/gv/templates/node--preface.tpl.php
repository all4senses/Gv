...
<?php endif; ?> <!-- if (!$page) -->
  ...
  ?>>
    ...
    <?php
      if ($current_is_reviews) {
        echo '<div id="all-reviews-snippet"><span id="count" property="v:count">99</span> Reviews for <span id="itemreviewed" property="v:itemreviewed">VoIP Providers</span><span class="rating-descr">, with average rating of <span property="v:best">5</span></span>';
      }
