        ...
        <div class="content"<?php print $content_attributes; ?>>
          ...
          <div class="links">
            ...
            <?php 
              ...
              echo ($page || $_GET['q'] == 'providers/reviews' ? l(t('View All !p Reviews', array('!p' => $node->field_r_provider_name['und'][0]['safe_value'])), 'node/' . $node->field_ref_provider['und'][0]['target_id']) . '<span class="delim">|</span>' . '<a href="' . $content['provider_url'] . '">' . t('Visit !p', array('!p' => '<span class="pname" property="v:itemreviewed">' . $node->field_r_provider_name['und'][0]['safe_value'] . '</span>')) . '</a>' . '<span class="delim">|</span>' : '<a href="' . $content['provider_url'] . '">' . t('Visit !p', array('!p' => '<span class="review-provider" property="v:itemreviewed">' . $node->field_r_provider_name['und'][0]['safe_value'] . '</span>')) . '</a>' . '<span class="delim">|</span>') . l(t('Write a Review'), 'node/add/review'); 
