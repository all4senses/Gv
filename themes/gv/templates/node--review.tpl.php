              ...
              echo '<div class="rlinks">' 
                  . (
                      ...
                      ? 
                        ...
                        ////( (!isset($node->field_ref_provider['und'][0]['target_id']) || !$node->field_ref_provider['und'][0]['target_id'] ) ? '' : (l('View All <span class="review-provider">' . (isset($node->field_r_provider_name[0]['value']) ? $node->field_r_provider_name[0]['value'] : $node->field_r_provider_name['und'][0]['value'] ) . '</span> Reviews', 'node/' . $node->field_ref_provider['und'][0]['target_id'])) . '<span class="delim">|</span>')
                      ...
                      . ( (!isset($content['provider_url']) || !$content['provider_url']) ? '' : l(' <span class="review-provider">Visit <span property="v:itemreviewed">' . (isset($node->field_r_provider_name[0]['value']) ? $node->field_r_provider_name[0]['value'] : $node->field_r_provider_name['und'][0]['value'] ) . '</span></span>', $content['provider_url']) . ' <span class="delim">|</span>')
                      ...
                      : ( (!isset($content['provider_url']) || !$content['provider_url']) ? '' : l('Visit <span class="review-provider" property="v:itemreviewed">' . $node->field_r_provider_name['und'][0]['safe_value'] . '</span>', $content['provider_url']) . ' <span class="delim">|</span>')
                    ) 
                    . l('Write a Review', 'node/add/review') 
                  . '</div>'; 
