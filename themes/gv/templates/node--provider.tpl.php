        ...
        <div class="content"<?php print $content_attributes; ?>>
           ...
           <?php if ($page): ?>
              ...
              <div class="basic-info">
                ...
                <div><?php if (!$node->p_data['info']['i_web_hide']) echo '<span class="title">' . t('Website') . ':</span>' . l(str_replace(array('http://', 'https://'), '', $node->p_data['info']['i_web']), $node->p_data['info']['i_web']); ?></div>
