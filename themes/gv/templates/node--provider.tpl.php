           ...
           <?php if ($page): ?>
              <div class="logo-share">
                <?php
                  if (isset($content['field_p_logo'][0]['#item']['uri'])) {
                    echo '<div class="logo" rel="v:photo"><a href="' . $node->p_data['info']['i_web'] . '">' . theme('image_style', array( 'path' =>  $content['field_p_logo'][0]['#item']['uri'], 'style_name' => 'logo_provider_page')) . '</a></div>'; 
                  }
                  else {
              ...
              <?php if (isset($content['gv_ratings']) && $content['gv_ratings']): ?>
                  ...
                  <div class="overall"> 
                    ...
                    <div class="star-big">
                      <?php echo /*render($content['gv_rating_overall'])*/ '<div class="count" property="v:rating">' . $node->gv_rating_overall . '</div>' . '<div class="descr">' . t('Out of 5 stars') . '</div>'; ?>
                    </div>
                  </div>
