              ...
              <div class="image">
                <?php
                  ...
                  if (isset($content['field_p_image'][0]['#item']['uri'])) {
                    ...
                    //////echo '<div><a href="/goto?t=provider&n=', urlencode($node->field_p_name['und'][0]['value']), '" rel="nofollow" target="_blank">' , theme('image_style', array( 'path' =>  $content['field_p_image'][0]['#item']['uri'], 'style_name' => 'image_provider_page', 'alt' =>  $content['field_p_image'][0]['#item']['alt'], 'title' =>  $content['field_p_image'][0]['#item']['title'])) , '</a></div>';
                  ...
                  if (!$node->p_data['info']['i_web_hide'] && !empty($node->p_data['info']['i_web'])) {
                      ...
                      '<div class="site">' , gv_misc_getTrackingUrl('Visit ' . $node->field_p_name['und'][0]['value']), '</div>';
              ...
              <?php if (isset($content['gv_ratings']) && $content['gv_ratings']): ?>
                  ...
                  <div class="overall"> 
                    <div class="text">
                      ...
                      <?php echo '<div id="positive">' . $node->gv_recommends['positive'] . '</div><div id="negative">' . $node->gv_recommends['negative'] . '</div>' ?>
                      <?php echo '<div class="recommend"><div class="title">' . t('Would recommend') . ': </div><div class="data">' . $node->gv_recommend . '% of Users' . '</div></div>'; ?>
                      <div class="title"><?php $node->field_p_name['und'][0]['value'] /*$content['field_p_name'][0]['#markup']*/ . ' ' . t('Overall Rated:'); ?></div>
                    </div>
                    <div class="star-big">
