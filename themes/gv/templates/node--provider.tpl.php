        ...
        <div class="content"<?php print $content_attributes; ?>>
           ...
           <?php if ($page): ?>
              ...
              <?php if (isset($content['gv_ratings']) && $content['gv_ratings']): ?>
                  ...
                  <div class="overall"> 
                    <div class="text">
                      <?php echo '<a id="write-review" href="/voip-provider-submit-user-review?id=' . $node->nid . '"><img src="/sites/default/files/writeareview.png" /></a><div class="voters"><div class="title">' . 'Number of Reviews' . ':</div><div class="count" property="v:count">' . $node->gv_voters . '</div></div>'; ?>
