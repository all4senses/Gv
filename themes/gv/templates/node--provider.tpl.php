            ...
            <div id="provider-top">
              ...
              <div class="basic-info" rel="v:itemreviewed">
                <div typeof="Organization">
                  <?php 
                    if ($user->uid == 1) {
                      echo '<div class="narrow stars-rating">' . theme('gv_misc_fivestar_static', array('rating' => $node->gv_rating_overall * 20, 'stars' => 5, 'tag' => 'overall', 'widget' => array('name' => 'stars', 'css' => 'stars.css'))) . '<a href="/"> Read Reviews</a></div>'; 
                    }
                  ?>
