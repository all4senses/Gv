<?php 
  ...
  if($view_mode == 'home_teaser') {
    ...
    echo $teaser_data['side_block_main_image'] . '<h3>'. l($node->title, 'node/' . $node->nid) . '</h3><div class="submitted">By <span class="author">' . $author_name . '</span> / ' . date('F d, Y', $node->created) . '</div>' 
