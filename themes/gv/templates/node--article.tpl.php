          ...
          <span class="submitted">
            <?php 
              ...
              elseif ($_SERVER['REQUEST_URI'] == '/') {
                ...
                echo ($node->type == 'blog_post' ? 'Blog' : 'News') . ' - By ' , l($author_name, 'user/' . $node->uid, array('attributes' => array('title' => $author_name . '\'s profile', 'class' => 'username'))), ' / ', gv_misc_elapsed_time($node->created);
              }
              else {
