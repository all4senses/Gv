...
<head>
  <title><?php global $altered_head_title; if ($altered_head_title) {print $altered_head_title; dpm('xxx $altered_head_title = ' . $altered_head_title); } else {print $head_title;} ?></title>
  <?php print $head; ?>
