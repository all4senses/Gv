    ...
    <nav id="navigation" role="navigation" class="clearfix">
      ...
      <div id="logo-block">
        <a href="<?php print $front_page; ?>" title="<?php print t('GetVoIP Home'); ?>" id="logo">
          <img src="<?php print 'http://getvoip.com/sites/all/themes/gv_orange/css/images/getvoip-logo.png'; ?>" alt="<?php print t('GetVoIP logo'); ?>" title="<?php print t('GetVoIP Home'); ?>" />
        </a>
        <div class="descr">
