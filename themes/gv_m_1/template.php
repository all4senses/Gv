 ...
 * 3. Read carefully, especially within gv_m_preprocess_html(), there
...
//    'gv_m.responsive.style.css',
//    'gv_m.responsive.gpanels.css'
//  );
//  load_subtheme_media_queries($media_queries_css, 'gv_m');
...
//  );
//  load_subtheme_ie_styles($ie_files, 'gv_m');
...
function gv_m_process_html(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function gv_m_preprocess_page(&$vars) {
}

function gv_m_process_page(&$vars) {
}
// */
...
function gv_m_preprocess_node(&$vars) {
}

function gv_m_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function gv_m_preprocess_comment(&$vars) {
}

function gv_m_process_comment(&$vars) {
}
// */
...
function gv_m_process_block(&$vars) {
}
// */
