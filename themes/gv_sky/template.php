 ...
 * 3. Read carefully, especially within gv_sky_preprocess_html(), there
...
//    'gv_sky.responsive.style.css',
//    'gv_sky.responsive.gpanels.css'
//  );
//  load_subtheme_media_queries($media_queries_css, 'gv_sky');
...
//  );
//  load_subtheme_ie_styles($ie_files, 'gv_sky');
...
function gv_sky_process_html(&$vars) {
}
// */
...
function gv_sky_process_page(&$vars) {
}
// */
...
function gv_sky_preprocess_node(&$vars) {
}

function gv_sky_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function gv_sky_preprocess_comment(&$vars) {
}

function gv_sky_process_comment(&$vars) {
}
// */
...
function gv_sky_process_block(&$vars) {
}
// */
