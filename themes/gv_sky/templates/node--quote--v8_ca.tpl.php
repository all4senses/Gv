  <?php
    if ($node->title == 'Request a Quote page v8_ca Final') {
  ...
  <div id="quote-content">
      ...
      <div class="full main">
        ...
        <div id="main-content"> 
              ...
              <?php if ($_SERVER['REDIRECT_URL'] == '/lpv8-ca-final'): ?>
              ...
              <?php else: ?>
                  ...
                  <div class="left">
                    ...
                    <div class="subtitle">In just under 2 minutes we'll match you with pre-screened VoIP providers that offer the best business phone systems for your specific needs.</div>
                     ...
                     <?php echo gv_blocks_get_requestQuoteForPage_v8_ca(); ?>
                  </div>
...
<?php if ($_SERVER['REDIRECT_URL'] == '/lpv8-ca-final'): /* If we are on the final page, after the submission */ ?> 
          ...
          <?php /*global $user; elseif ($user->uid != 1): // If we get the final page from an other page, what is INCORRECT, we just redirect a user to the main quote page.?>
            <script>top.location.href="http://getvoip.com/lpv8-ca";</script>
          <?php endif;*/?>
    
<?php else: // Else of if ($_SERVER['REDIRECT_URL'] == '/lpv8-ca-final'):
// So we are on the lending page '/lpv8-ca' 
?>
...
<?php endif; // End of Else of if ($_SERVER['REDIRECT_URL'] == '/lpv8-ca-final'):?>
