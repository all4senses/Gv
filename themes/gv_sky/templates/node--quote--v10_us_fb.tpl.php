  ...
  ?>
      ...
      <main class="main section full-height" role="main">
        ...
        <?php if (!$final_page): ?>
          ...
          <?php echo gv_blocks_get_requestQuoteForPage_v10('us-fb'); ?>
          ...
          <div class="form-main pdf-page">
            ...
            <form class="form">
              <div class="step one show">
                <div class="wrap">
                  <a href="http://getvoip.com/pdfs/hosted-voip-guide-2015.pdf" target="_blank"><div class="download"><div class="icon-download"></div><span>Download PDF</span></div></a>
                </div>
...
<?php if ($final_page): ?> 
            ...
            <!-- Facebook Conversion Code for LP10 -->
            <script>(function() {
            ...
            window._fbq.push(['track', '6030122289374', {'value':'0.01','currency':'USD'}]);
            </script>
            <noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6030122289374&amp;cd[value]=0.01&amp;cd[currency]=USD&amp;noscript=1" /></noscript>
