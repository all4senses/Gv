  <?php
    if ($node->title == 'Request a Quote page v7_ca Final') {
  ...
  <div id="quote-content">
      ...
      <div class="full main">
        ...
        <div id="main-content">
              ...
              <div class="content<?php echo ($_SERVER['REDIRECT_URL'] == '/service-quotes-ca-final' ? ' final' : '')?>"<?php print $content_attributes; ?>>
              ...
              */ ?>
              ...
              <?php if ($_SERVER['REDIRECT_URL'] == '/service-quotes-ca-final'): ?>

                  <div class="right final">
                    <?php  
                    //echo '<a class="guide" href="/pdfs/hosted-voip-guide-2015.pdf" target="_blank">Download Your Free VoIP Buyer\'s Guide<img src="/sites/all/themes/gv_orange/css/images/click-here-button.png" /></a><div class="quote-final">' . t('<p><strong>Thank you</strong> for taking your time to complete our form. A VoIP Expert will be contacting you shortly to provide you with a personalized VoIP Service quote.</p><p>In the meantime, you can gain a great deal of VoIP information right here at <a href="http://getvoip.com">GetVoIP.com</a></p>') . '</div>';
                    
                    echo '<a class="guide" href="/pdfs/hosted-voip-guide-2015.pdf" target="_blank">Download Your Free VoIP Buyer\'s Guide'
              ...
              <?php else: ?>
                  ...
                  <div class="right">
                    <div id="right-bottom">
                      <?php echo gv_blocks_get_requestQuoteForPage_v7_ca(); ?>
                      <div class="bottom-clear"></div> 
                    </div>
                  </div>
...
<?php if ($_SERVER['REDIRECT_URL'] == '/service-quotes-ca-final'): /* If we are on the final page, after the submission */ ?> 

          <?php /*if ($_SERVER['HTTP_REFERER'] == 'http://getvoip.com/service-quotes-ca'):*/  /* If we get the final page from the main quote page, what is correct.*/ ?> 
          ...
          <?php /*global $user; elseif ($user->uid != 1): // If we get the final page from an other page, what is INCORRECT, we just redirect a user to the main quote page.?>
            <script>top.location.href="http://getvoip.com/service-quotes-ca";</script>
          <?php endif;*/?>
    
<?php else: // Else of if ($_SERVER['REDIRECT_URL'] == '/service-quotes-ca-final'):
// So we are on the lending page '/service-quotes-ca' 
?>
...
<?php endif; // End of Else of if ($_SERVER['REDIRECT_URL'] == '/service-quotes-ca-final'):?>
