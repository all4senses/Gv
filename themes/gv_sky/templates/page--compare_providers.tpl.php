    ...
    <nav class="navigation" role="navigation">
      ...
      <div class="hero-header left">
        <div class="hero-title">
          <h1 class="hero-title-heading"><?php print (isset($hero_title) ? $hero_title : render($title)); ?></h1>
          <p class="hero-title-desc"><?php  print (isset($hero_subtitle) ? $hero_subtitle : field_get_items('node',$node, 'body')[0]['value']); ?></p>
        </div>
      </div>
  </header>
