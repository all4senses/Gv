        ...
        <div id="main-content">
              ...
              */ ?>
              ...
              <?php else: ?>
                  ...
                  <div class="right">
                    <div id="right-bottom">
                      <?php echo gv_blocks_get_requestQuoteForPage_v7_uk(); ?>
                      <div class="bottom-clear"></div> 
                    </div>
                  </div>
...
<?php if ($_SERVER['REDIRECT_URL'] == '/service-quotes-uk-final'): /* If we are on the final page, after the submission */ ?> 
          ...
          <?php /*if ($_SERVER['HTTP_REFERER'] == 'http://getvoip.com/service-quotes-uk'):*/  /* If we get the final page from the main quote page, what is correct.*/ ?> 
          ...
          <?php /*global $user; elseif ($user->uid != 1): // If we get the final page from an other page, what is INCORRECT, we just redirect a user to the main quote page.?>
            <script>top.location.href="http://getvoip.com/service-quotes-uk";</script>
          <?php endif;*/?>
