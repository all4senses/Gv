  <?php
    if ($node->title == 'Request a Quote page v7_uk_ppc Final') {
  ...
  <div id="quote-content">
      ...
      <div class="full main">
        ...
        <div id="main-content">
              ...
              <div class="content<?php echo ($_SERVER['REDIRECT_URL'] == '/ppc/service-quotes-final' ? ' final' : '')?>"<?php print $content_attributes; ?>>
              ...
              */ ?>
              ...
              <?php if ($_SERVER['REDIRECT_URL'] == '/ppc/service-quotes-final'): ?>
              ...
              <?php else: ?>
                  ...
                  <div class="right">
                    <div id="right-bottom">
                      <?php echo gv_blocks_get_requestQuoteForPage_v7_uk_ppc(); ?>
                      <div class="bottom-clear"></div> 
                    </div>
                  </div>
...
<?php if ($_SERVER['REDIRECT_URL'] == '/ppc/service-quotes-final'): /* If we are on the final page, after the submission */ ?> 
          ...
          <?php /*global $user; elseif ($user->uid != 1): // If we get the final page from an other page, what is INCORRECT, we just redirect a user to the main quote page.?>
            <script>top.location.href="http://getvoip.com/ppc/service-quotes";</script>
          <?php endif;*/?>
    
<?php else: // Else of if ($_SERVER['REDIRECT_URL'] == '/ppc/service-quotes-final'):
// So we are on the lending page '/ppc/service-quotes' 
?>
...
<?php endif; // End of Else of if ($_SERVER['REDIRECT_URL'] == '/ppc/service-quotes-final'):?>
