  <?php
    if ($node->title == 'Request a Quote page v9_uk Final') {
  ...
  <div id="quote-content">
      ...
      <div class="full main">
        ...
        <div id="main-content"> 
              ...
              <?php if ($_SERVER['REDIRECT_URL'] == '/lpv9-uk-final'): ?>
              ...
              <?php else: ?>
                  ...
                  <div class="left">
                    ...
                    <div class="subtitle">In just under 2 minutes we'll match you with pre-screened VoIP providers that offer the best business phone systems for your specific needs.</div>
                     ...
                     <?php echo gv_blocks_get_requestQuoteForPage_v9_uk(); ?>
                  </div>
...
</div> <!-- End of <div id="v9_uk"> -->



<?php if ($_SERVER['REDIRECT_URL'] == '/lpv9-uk-final'): /* If we are on the final page, after the submission */ ?> 

          <?php /*if ($_SERVER['HTTP_REFERER'] == 'http://getvoip.com/lpv9_uk'):*/  /* If we get the final page from the main quote page, what is correct.*/ ?> 
          ...
          <?php /*global $user; elseif ($user->uid != 1): // If we get the final page from an other page, what is INCORRECT, we just redirect a user to the main quote page.?>
            <script>top.location.href="http://getvoip.com/lpv9_uk";</script>
          <?php endif;*/?>
    
<?php else: // Else of if ($_SERVER['REDIRECT_URL'] == '/lpv9-uk-final'):
// So we are on the lending page '/lpv9_uk' 
?>
...
<?php endif; // End of Else of if ($_SERVER['REDIRECT_URL'] == '/lpv9-uk-final'):?>
