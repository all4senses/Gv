  ...
  ?>
      ...
      <header id="masthead" class="site-header" role="banner">
        <div class="wrap">
          ...
          <div class="slogan-wrap">
            <div class="slogan">Call Center Advisor Trusted by <span>Millions</span></div>
          </div>
      ...
      <main class="main section full-height cc" role="main">
        ...
        <?php if (!$final_page): ?>
          ...
          <?php echo gv_blocks_get_requestQuoteForPage_v10_cc(); ?>
          ...
          <div class="form-main pdf-page">
            ...
            <form class="form">
              <div class="step one show">
                <div class="wrap">
                  <a href="http://getvoip.com/pdfs/cloud-contact-center-buyers-guide.pdf" target="_blank"><div class="download"><div class="icon-download"></div><span>Download PDF</span></div></a>
                </div>
