    ...
    <nav id="navigation" role="navigation" class="clearfix">
      ...
      <div id="logo-block">
        <a href="<?php print $front_page; ?>" title="<?php print 'GetVoIP Home'; ?>" id="logo">
          <?php
              //echo '<img src="http://getvoip.com/sites/all/themes/gv_m/css/images/get-voip-logo.png" alt="GetVoIP" title="GetVoIP" />';
        ...
        <div class="descr">
          ...
          <!--<div class="stars"><img src="/sites/all/themes/gv_m/css/images/sprite-0.png" alt="Provider Reviews From Consumers" title="VoIP Reviews"/></div>-->
