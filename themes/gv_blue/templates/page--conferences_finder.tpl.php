...
//            }
            ...
            echo '<table class="conf-table"><tbody>',
                    ...
                    . '<canvas id="link-1" width=40 height=40 style="position: absolute; top: 0; left: 3px;"></canvas>'
                    ...
                    . '<canvas id="link-2" width=40 height=40 style="position: absolute; top: 0; left: 3px;"></canvas>'
                    ...
                    '<tr><td class="footer">© Copyright 2015 GetVoIP.com | All Rights Reserved</div></td></tr>',
