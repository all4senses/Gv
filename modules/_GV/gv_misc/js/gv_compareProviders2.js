       ...
       $(".p-compare").click(function(e){
         ...
         if (!checked_count) {
           ...
           $('#b2').remove();
            ...
            $('#b2').remove();
            if ($(this)[0].checked) {
              $(this).parent().parent().append('<div class="compare-button" id="b2" style="display: block !important;"><img src="/sites/all/themes/gv_orange/css/images/compare-btn-next3.png"/></div>');
            }
            else {
             //console.log(checkboxes_checked[0]);
             $(checkboxes_checked[checked_count - 1]).parent().parent().append('<div class="compare-button" id="b2" style="display: block !important;"><img src="/sites/all/themes/gv_orange/css/images/compare-btn-next3.png"/></div>');
            }
