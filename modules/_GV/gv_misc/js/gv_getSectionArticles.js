...
//                                          }
          ...
          if (this_button.opened) {
            ...
            $(this_button).css('background', 'url("images/section-view-less.png") no-repeat 0 0 transparent');
            console.log('Opened!');
          }
          else {
            ...
            $(this_button).css('background', 'url("images/section-view-all.png") no-repeat 0 0 transparent');
            console.log('Not opened!');
          }
