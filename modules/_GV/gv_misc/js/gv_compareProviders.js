(function ($) {
  ...
  Drupal.behaviors.gv_compareProviders = {
    attach: function (context, settings) {
       ...
       $('#block-views-providers-block_top_business_cmp').append('<div class="compare-button" id="b1" style="display: none; height: 100px; width: 35px; background-color: red; position: absolute; right: -10px;top: 220px;"><img src="/sites/all/themes/gv_orange/css/images/compare-button2.png" style="heigh: 150px;"/></div>');
