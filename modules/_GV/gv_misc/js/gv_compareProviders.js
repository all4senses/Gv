         ...
         if (!checked_count) {
           ...
           $('#b2').remove();
            ...
            if ($(this)[0].checked) {
              ...
              var b_top = ($(this).parent().parent().height()/2 - 35) - $(this).parent().parent().height()/2;
             ...
             //console.log(checkboxes_checked[0]);
              ...
              var b_top = $(checkboxes_checked[checked_count - 1]).parent().parent().height()/2 - 35 - $(this).parent().parent().height()/2;
