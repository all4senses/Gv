(function ($) {
 ...
 function animate_1(current) {
     ...
     if (curPerc_1 < endPercent_1) {
         ...
         $(".embed .link").find(".open").css({opacity: 0, visibility: "visible", display: "block", left: "-350px"}).animate({opacity: 1, left: 0}, 500);
     }
 ...
 function animate_2(current) {
    //console.log('a2 ' +  current);
     ...
     if (curPerc_2 < endPercent_2) {
        ...
        $(".add-conf .link").find(".open").css({opacity: 0, visibility: "visible", display: "block", left: "-350px"}).animate({opacity: 1, left: 0}, 500);
     }
